...
class ProdutoGateway
{
    ...
    {
        print $this->id;//retorna o id
        echo "<br>";
        print $this->data['id'];//retorna o mesmo valor de $this->id
        echo "<br>";
        if (empty($this->data['id'])) //ou $this->data['id']
        {
            print $this->id;//ele entra como se estivesse vazio, mas retorna o valor do id?????
            echo "<br>";    
            $id = $this->getLastId() +1;
    ...
    private function getLastId()
    {
        ...
        $result = self::$conn->query($sql);
        $data = $result->fetch(PDO::FETCH_OBJ);//ou fetObJECT
        return $data->max;
    }
