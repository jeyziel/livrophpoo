    ...
    public function addItem($object)
    {
        ...
        if ($this->actions)
        {
            ...
            foreach ($this->actions as $action)
            {
                ...
                $label = $action->getLabel();//vizualizar,editar,excluir
                $image = $action->getImage();
                $field = $action->getField();//campo do bando de dados id,nome,etc
        ...
        if ($this->columns)
        {
            ...
            foreach ($this->columns as $column)
            {
                ...
                $data     = $object->$name; //pega os nomes dos campo id,email,assunto
